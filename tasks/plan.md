...
**Fechamento T17:** Ruleset `main-protection` (`24014122`) ativo, sem bypass actors, com PR e check `ci` obrigatórios em modo strict, deletion e non-fast-forward bloqueados. Push direto rejeitado com `GH013`. PR #19 com `ci` em falha permaneceu BLOCKED e foi fechada sem merge. TLS/borda PASS: Let's Encrypt, Home 200, 404 da marca, health e quatro security headers. Access logs DISABLED e KEEP DISABLED, sem mutação global do proxy. A ambiguidade anterior, em que só `health.version` sustentava o rollback, foi eliminada. Rollback de `3a7a9984fa3aa33a64d1ba02709f6b78c398f5ba` para `95f16f6cbb62db273f3c00bc33389efbe25774d7` e restauração para `3a7a9984fa3aa33a64d1ba02709f6b78c398f5ba` PASS: a identidade foi verificada de forma independente por tag da imagem, image ID, `APP_VERSION` no Config da imagem, release pública embutida e `health.version`. A imagem em execução na restauração é `ly3lndsfdmzbe6z5ubun1q5d:3a7a9984fa3aa33a64d1ba02709f6b78c398f5ba`. Produção final novamente em `3a7a9984fa3aa33a64d1ba02709f6b78c398f5ba`.
