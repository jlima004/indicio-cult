...
A marca se posiciona como *marca de arte impressa para pessoas de repertório específico*, não como "loja de camisetas cult". Trata alienação, corpo fragmentado, futuro opaco, memória cultural e ruído tecnológico como sintomas do presente — sem transformar sofrimento em estética vazia.
